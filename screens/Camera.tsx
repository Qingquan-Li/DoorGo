...
//next is getting geo location
//design it with how it will be used in mind
//
...
export default function CameraP({ navigation }: { navigation: any }) {
  ...
  if (hasCameraPermission === undefined) {
    ...
    return <Text>Access not granted, Please grant permission in settings</Text>;
  }
      ...
      <Camera style={styles.camera} type={type} ref={cameraRef}>
        <View style={styles.container}>
          <TouchableOpacity
            ...
            onPress={takePicture} /*and then navigate to attributes*/
          />
          <TouchableOpacity
